var TableEditableEntinit = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[3].innerHTML = '<input type="text" class="form-control input-medium" readonly="readonly" value="A">';
        ...
        function saveRow(oTable, nRow) {
            ...
            if(jqInputs[0].value==''&&jqInputs[1].value==''&&jqInputs[2].value==''){
                ...
                $('#regNo').val(jqInputs[0].value);
                $('#creditNo').val(jqInputs[1].value);
                $('#name').val(jqInputs[2].value);
                $('#flag').val(jqInputs[3].value);
                judge = true ;
            }
        }
