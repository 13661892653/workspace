	...
	var Pagination = function(element,options){
		...
		this.filling = function(index){
			...
			if(current < pageCount){//下一页
				html += '<a href="javascript:;" class="'+opts.nextCls+'">'+opts.nextContent+'</a><p>共' + pageCount + '页</p>'
			}else{
				$obj.find('.'+opts.nextCls) && $obj.find('.'+opts.nextCls).remove();
			}

			html += opts.jump ? '<p class="jumparea">到第<input type="text" class="'+opts.jumpIptCls+'">页<a href="javascript:;" class="'+opts.jumpBtnCls+'">'+opts.jumpBtn+'</a></p>' : '';
