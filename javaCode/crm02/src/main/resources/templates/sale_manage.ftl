...
<head>
    ...
    <!-- <link href="/dist/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color" /> -->
...
<#include "left_menu.ftl"/>
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <span>一、销售任务分配</br>
                1、服务对象、接单人、派单人、时间</br>
                2、销售进度、阶段、状态、结果、下单情况、合同签订情况、付款情况</br>
                3、回款预警以及消息自动触发</br></br>
                （功能暂未开发，敬请期待）
            </span>
        </div>
