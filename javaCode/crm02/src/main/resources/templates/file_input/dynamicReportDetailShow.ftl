...
<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo">
                        ...
                        <div class="container">
                            ...
                            <form id="posttable" class="form-inline">
                                ...
                                <div class="pure-control-group">
                                    ...
                                    <p class="msg">必填项</p>-->
                                    <span id="enterpriseName" class="inputArea"></span>
                                </div>
                                <div class="pure-control-group">
                                    <label for="date">报表时间</label>
                                    <span id="date" class="inputArea"></span>
    ...
    <script src="/js/dynamicReport/jsDynamicDetailShow.js"></script>
    <script>
                        ...
                        <tr>
                            <% }%>
                                <% for ( var j = 0; j < e.length; j++ ) { var e1=e[j];%>
                                    <th>
                                        <%if(e1.type=="input"){%>
                                            <div id="<%=e1.content%>" class="inputArea"></div>
                                            <% }else{%>
                                                <%=e1.content%>
                                                    <% }%>
                                    </th>
