            ...
            <div class="page-content">
                ...
                <div class="portlet">
                    <div class="portlet-body">
                            ...
                            <form id="posttable" class="form-inline">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <div class="btn btn-success submit" data-submitId="2">提交</div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="container">
                                <form id="reject" class="form-inline">
                                    <div class="pure-control-group" style="padding-top: 10px;">
                                        <label for="remark" style="vertical-align: top;">驳回原因</label>
                                        <textarea name="remark" type="text" id="remark" required></textarea>
                                        <p class="msg">必填项</p>
                                    </div>
                                    <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <div class="btn btn-success rejectbtn">驳回</div>
                                    </div>
                                </div>
                                </form>
                            </div>
