...
public class JXNormalProfitTableDto extends ProfitTableDto {
    ...
    private String proceedsFromTheDisposalOrDisposalUnitMonth;        //出售、处置部门或被投资单位所得收益 本年累计
    private String proceedsFromTheDisposalOrDisposalUnitYear;       //上年实际
    private String naturalDisasterLossMonth;        //自然灾害发生的损失本年累计
    private String naturalDisasterLossYear;     //上年实际
    private String increaseTotalProfitOfAccountingPolicyChangeMonth;        //会计政策变更增加（或减少）利润总额 本年累计
    private String increaseTotalProfitOfAccountingPolicyChangeYear;     //上年实际
    private String increaseTotalProfitOfAccountingEstimateChangeMonth;      //会计估计变更增加（或减少）利润总额 本年累计
    private String increaseTotalProfitOfAccountingEstimateChangeYear;       //上年实际
    private String debtRestructuringLossMonth;      //债务重组损失 本年累计
    private String debtRestructuringLossYear;       //上年实际
    private String otherMonth;      //其他 本年累计
    private String otherYear;       //上年实际
