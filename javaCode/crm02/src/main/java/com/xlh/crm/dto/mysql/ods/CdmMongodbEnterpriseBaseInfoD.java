...
public class CdmMongodbEnterpriseBaseInfoD {
    ...
    public String getAboveCollegeNum() {
        return aboveCollegeNum;
    }

    public void setAboveCollegeNum(String aboveCollegeNum) {
        this.aboveCollegeNum = aboveCollegeNum;
    }
    ...
    public void setResearchNum(String researchNum) {
        this.researchNum = researchNum;
    }

    public String getHightecSales() {
        return hightecSales;
    }

    public void setHightecSales(String hightecSales) {
        this.hightecSales = hightecSales;
    }
