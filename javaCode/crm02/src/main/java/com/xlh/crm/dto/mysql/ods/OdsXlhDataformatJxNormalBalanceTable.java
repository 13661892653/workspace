...
public class OdsXlhDataformatJxNormalBalanceTable {
    @Id
    private Integer id;
    ...
    private String payrollPayableBegin;     //　应付工资
    private String payrollPayableEnd;
    private String accountsReceivableBegin;     //应收账款
    private String accountsReceivableEnd;
    private String welfarePayableBegin;     //应付福利费
    private String welfarePayableEnd;
    ...
    private String taxPayableBegin;     //应交税金
    private String taxPayableEnd;
    private String subsidiesReceivableBegin;        //应收补贴款
    private String subsidiesReceivableEnd;
    private String otherPayablesBegin;      //其他应交款
    private String otherPayablesEnd;
    private String stockBegin;      //存货
    private String stockEnd;
    private String otherPayableBegin;       //其他应付款81
    private String otherPayableEnd;
    private String prepaidExpensesBegin;        //待摊费用
    private String prepaidExpensesEnd;
    private String accruedExpensesBegin;        //预提费用
    private String accruedExpensesEnd;
    private String longTermDebtInvestmentDueWithinOneYearBegin;     //一年内到期的长期债权投资
    private String longTermDebtInvestmentDueWithinOneYearEnd;
    ...
    private String longTermLiabilitiesDueWithinOneYearBegin;        //一年内到期的长期负债
    private String longTermLiabilitiesDueWithinOneYearEnd;
    ...
    private String longTermDebtInvestmentDueBegin;     //长期债权投资
    private String longTermDebtInvestmentDueEnd;
    private String longTermBorrowingBegin;      //长期借款
    private String longTermBorrowingEnd;
    private String totalLongTermInvestmentBegin;        //长期投资合计
    private String totalLongTermInvestmentEnd;
    private String bondsPayableBegin;       //应付债券
    private String bondsPayableEnd;
    private String fixOtherPayableBegin;       //其他应付款103
    private String fixOtherPayableEnd;
    ...
    private String otherLongTermLiabilitiesBegin;       //其他长期负债
    private String otherLongTermLiabilitiesEnd;
    private String netValueOfFixedAssetsBegin;      //固定资产净值
    private String netValueOfFixedAssetsEnd;
    private String totalLongTermLiabilitiesBegin;       //长期负债合计
    private String totalLongTermLiabilitiesEnd;
    private String fixedAssetsDepreciationReservesBegin;        //固定资产减值准备
    private String fixedAssetsDepreciationReservesEnd;
    private String netFixedAssetsBegin;     //固定资产净额
    private String netFixedAssetsEnd;
    private String deferredTaxCreditsBegin;     //递延税款贷项
    private String deferredTaxCreditsEnd;
    ...
    private String totalFixedAssetsBegin;       //固定资产合计
    private String totalFixedAssetsEnd;
    private String paidInCapitalBegin;      //实收资本（或股本）
    private String paidInCapitalEnd;
    private String investmentReturnedBegin;     //已归还投资
    private String investmentReturnedEnd;
    private String intangibleAssetsBegin;       //无形资产
    private String intangibleAssetsEnd;
    private String paidInCapitalNetBegin;      //实收资本（或股本）净额
    private String paidInCapitalNetEnd;
    ...
    private String otherLongTermAssetsBegin;        //其他长期资产
    private String otherLongTermAssetsEnd;
    private String surplusReserveBegin;     //盈余公积
    private String surplusReserveEnd;
    private String totalIntangibleAssetsAndOtherAssetsBegin;        //无形资产及其他资产合计
    private String totalIntangibleAssetsAndOtherAssetsEnd;
    private String statutoryPublicWelfareFundBegin;     //法定公益金
    private String statutoryPublicWelfareFundEnd;
    private String undistributedProfitBegin;        //未分配利润
    private String undistributedProfitEnd;
    private String deferredTaxAssetsBegin;      //递延税款借项
    private String deferredTaxAssetsEnd;
    private String totalOwnerEquityBegin;       //所有者权益（或股东权益）合计
    private String totalOwnerEquityEnd;
    private String totalAssetsBegin;        //资产总计
    private String totalAssetsEnd;
    private String totalLiabilitiesAndOwnerEquityBegin;     //负债和所有者权益(或股东权益)合计
    ...
    public String getWelfarePayableBegin() {
        return welfarePayableBegin;
    }

    public void setWelfarePayableBegin(String welfarePayableBegin) {
        this.welfarePayableBegin = welfarePayableBegin;
    }

    public String getWelfarePayableEnd() {
        return welfarePayableEnd;
    }

    public void setWelfarePayableEnd(String welfarePayableEnd) {
        this.welfarePayableEnd = welfarePayableEnd;
    }
    ...
    public String getSubsidiesReceivableBegin() {
        return subsidiesReceivableBegin;
    }

    public void setSubsidiesReceivableBegin(String subsidiesReceivableBegin) {
        this.subsidiesReceivableBegin = subsidiesReceivableBegin;
    }

    public String getSubsidiesReceivableEnd() {
        return subsidiesReceivableEnd;
    }

    public void setSubsidiesReceivableEnd(String subsidiesReceivableEnd) {
        this.subsidiesReceivableEnd = subsidiesReceivableEnd;
    }

    public String getOtherPayablesBegin() {
        return otherPayablesBegin;
    }

    public void setOtherPayablesBegin(String otherPayablesBegin) {
        this.otherPayablesBegin = otherPayablesBegin;
    }

    public String getOtherPayablesEnd() {
        return otherPayablesEnd;
    }

    public void setOtherPayablesEnd(String otherPayablesEnd) {
        this.otherPayablesEnd = otherPayablesEnd;
    }
    ...
    public String getPrepaidExpensesBegin() {
        return prepaidExpensesBegin;
    }

    public void setPrepaidExpensesBegin(String prepaidExpensesBegin) {
        this.prepaidExpensesBegin = prepaidExpensesBegin;
    }

    public String getPrepaidExpensesEnd() {
        return prepaidExpensesEnd;
    }

    public void setPrepaidExpensesEnd(String prepaidExpensesEnd) {
        this.prepaidExpensesEnd = prepaidExpensesEnd;
    }

    public String getAccruedExpensesBegin() {
        return accruedExpensesBegin;
    }

    public void setAccruedExpensesBegin(String accruedExpensesBegin) {
        this.accruedExpensesBegin = accruedExpensesBegin;
    }

    public String getAccruedExpensesEnd() {
        return accruedExpensesEnd;
    }

    public void setAccruedExpensesEnd(String accruedExpensesEnd) {
        this.accruedExpensesEnd = accruedExpensesEnd;
    }

    public String getLongTermDebtInvestmentDueWithinOneYearBegin() {
        return longTermDebtInvestmentDueWithinOneYearBegin;
    }

    public void setLongTermDebtInvestmentDueWithinOneYearBegin(String longTermDebtInvestmentDueWithinOneYearBegin) {
        this.longTermDebtInvestmentDueWithinOneYearBegin = longTermDebtInvestmentDueWithinOneYearBegin;
    }

    public String getLongTermDebtInvestmentDueWithinOneYearEnd() {
        return longTermDebtInvestmentDueWithinOneYearEnd;
    }

    public void setLongTermDebtInvestmentDueWithinOneYearEnd(String longTermDebtInvestmentDueWithinOneYearEnd) {
        this.longTermDebtInvestmentDueWithinOneYearEnd = longTermDebtInvestmentDueWithinOneYearEnd;
    }
    ...
    public String getLongTermLiabilitiesDueWithinOneYearBegin() {
        return longTermLiabilitiesDueWithinOneYearBegin;
    }

    public void setLongTermLiabilitiesDueWithinOneYearBegin(String longTermLiabilitiesDueWithinOneYearBegin) {
        this.longTermLiabilitiesDueWithinOneYearBegin = longTermLiabilitiesDueWithinOneYearBegin;
    }

    public String getLongTermLiabilitiesDueWithinOneYearEnd() {
        return longTermLiabilitiesDueWithinOneYearEnd;
    }

    public void setLongTermLiabilitiesDueWithinOneYearEnd(String longTermLiabilitiesDueWithinOneYearEnd) {
        this.longTermLiabilitiesDueWithinOneYearEnd = longTermLiabilitiesDueWithinOneYearEnd;
    }
    ...
    public String getLongTermDebtInvestmentDueBegin() {
        return longTermDebtInvestmentDueBegin;
    }

    public void setLongTermDebtInvestmentDueBegin(String longTermDebtInvestmentDueBegin) {
        this.longTermDebtInvestmentDueBegin = longTermDebtInvestmentDueBegin;
    }

    public String getLongTermDebtInvestmentDueEnd() {
        return longTermDebtInvestmentDueEnd;
    }

    public void setLongTermDebtInvestmentDueEnd(String longTermDebtInvestmentDueEnd) {
        this.longTermDebtInvestmentDueEnd = longTermDebtInvestmentDueEnd;
    }
    ...
    public String getTotalLongTermInvestmentBegin() {
        return totalLongTermInvestmentBegin;
    }

    public void setTotalLongTermInvestmentBegin(String totalLongTermInvestmentBegin) {
        this.totalLongTermInvestmentBegin = totalLongTermInvestmentBegin;
    }

    public String getTotalLongTermInvestmentEnd() {
        return totalLongTermInvestmentEnd;
    }

    public void setTotalLongTermInvestmentEnd(String totalLongTermInvestmentEnd) {
        this.totalLongTermInvestmentEnd = totalLongTermInvestmentEnd;
    }
    ...
    public String getFixOtherPayableBegin() {
        return fixOtherPayableBegin;
    }

    public void setFixOtherPayableBegin(String fixOtherPayableBegin) {
        this.fixOtherPayableBegin = fixOtherPayableBegin;
    }

    public String getFixOtherPayableEnd() {
        return fixOtherPayableEnd;
    }

    public void setFixOtherPayableEnd(String fixOtherPayableEnd) {
        this.fixOtherPayableEnd = fixOtherPayableEnd;
    }
    ...
    public String getOtherLongTermLiabilitiesBegin() {
        return otherLongTermLiabilitiesBegin;
    }

    public void setOtherLongTermLiabilitiesBegin(String otherLongTermLiabilitiesBegin) {
        this.otherLongTermLiabilitiesBegin = otherLongTermLiabilitiesBegin;
    }

    public String getOtherLongTermLiabilitiesEnd() {
        return otherLongTermLiabilitiesEnd;
    }

    public void setOtherLongTermLiabilitiesEnd(String otherLongTermLiabilitiesEnd) {
        this.otherLongTermLiabilitiesEnd = otherLongTermLiabilitiesEnd;
    }

    public String getNetValueOfFixedAssetsBegin() {
        return netValueOfFixedAssetsBegin;
    }

    public void setNetValueOfFixedAssetsBegin(String netValueOfFixedAssetsBegin) {
        this.netValueOfFixedAssetsBegin = netValueOfFixedAssetsBegin;
    }

    public String getNetValueOfFixedAssetsEnd() {
        return netValueOfFixedAssetsEnd;
    }

    public void setNetValueOfFixedAssetsEnd(String netValueOfFixedAssetsEnd) {
        this.netValueOfFixedAssetsEnd = netValueOfFixedAssetsEnd;
    }

    public String getTotalLongTermLiabilitiesBegin() {
        return totalLongTermLiabilitiesBegin;
    }

    public void setTotalLongTermLiabilitiesBegin(String totalLongTermLiabilitiesBegin) {
        this.totalLongTermLiabilitiesBegin = totalLongTermLiabilitiesBegin;
    }

    public String getTotalLongTermLiabilitiesEnd() {
        return totalLongTermLiabilitiesEnd;
    }

    public void setTotalLongTermLiabilitiesEnd(String totalLongTermLiabilitiesEnd) {
        this.totalLongTermLiabilitiesEnd = totalLongTermLiabilitiesEnd;
    }

    public String getFixedAssetsDepreciationReservesBegin() {
        return fixedAssetsDepreciationReservesBegin;
    }

    public void setFixedAssetsDepreciationReservesBegin(String fixedAssetsDepreciationReservesBegin) {
        this.fixedAssetsDepreciationReservesBegin = fixedAssetsDepreciationReservesBegin;
    }

    public String getFixedAssetsDepreciationReservesEnd() {
        return fixedAssetsDepreciationReservesEnd;
    }

    public void setFixedAssetsDepreciationReservesEnd(String fixedAssetsDepreciationReservesEnd) {
        this.fixedAssetsDepreciationReservesEnd = fixedAssetsDepreciationReservesEnd;
    }

    public String getNetFixedAssetsBegin() {
        return netFixedAssetsBegin;
    }

    public void setNetFixedAssetsBegin(String netFixedAssetsBegin) {
        this.netFixedAssetsBegin = netFixedAssetsBegin;
    }

    public String getNetFixedAssetsEnd() {
        return netFixedAssetsEnd;
    }

    public void setNetFixedAssetsEnd(String netFixedAssetsEnd) {
        this.netFixedAssetsEnd = netFixedAssetsEnd;
    }

    public String getDeferredTaxCreditsBegin() {
        return deferredTaxCreditsBegin;
    }

    public void setDeferredTaxCreditsBegin(String deferredTaxCreditsBegin) {
        this.deferredTaxCreditsBegin = deferredTaxCreditsBegin;
    }

    public String getDeferredTaxCreditsEnd() {
        return deferredTaxCreditsEnd;
    }

    public void setDeferredTaxCreditsEnd(String deferredTaxCreditsEnd) {
        this.deferredTaxCreditsEnd = deferredTaxCreditsEnd;
    }
    ...
    public String getTotalFixedAssetsBegin() {
        return totalFixedAssetsBegin;
    }

    public void setTotalFixedAssetsBegin(String totalFixedAssetsBegin) {
        this.totalFixedAssetsBegin = totalFixedAssetsBegin;
    }

    public String getTotalFixedAssetsEnd() {
        return totalFixedAssetsEnd;
    }

    public void setTotalFixedAssetsEnd(String totalFixedAssetsEnd) {
        this.totalFixedAssetsEnd = totalFixedAssetsEnd;
    }
    ...
    public String getInvestmentReturnedBegin() {
        return investmentReturnedBegin;
    }

    public void setInvestmentReturnedBegin(String investmentReturnedBegin) {
        this.investmentReturnedBegin = investmentReturnedBegin;
    }

    public String getInvestmentReturnedEnd() {
        return investmentReturnedEnd;
    }

    public void setInvestmentReturnedEnd(String investmentReturnedEnd) {
        this.investmentReturnedEnd = investmentReturnedEnd;
    }
    ...
    public String getPaidInCapitalNetBegin() {
        return paidInCapitalNetBegin;
    }

    public void setPaidInCapitalNetBegin(String paidInCapitalNetBegin) {
        this.paidInCapitalNetBegin = paidInCapitalNetBegin;
    }

    public String getPaidInCapitalNetEnd() {
        return paidInCapitalNetEnd;
    }

    public void setPaidInCapitalNetEnd(String paidInCapitalNetEnd) {
        this.paidInCapitalNetEnd = paidInCapitalNetEnd;
    }
    ...
    public String getOtherLongTermAssetsBegin() {
        return otherLongTermAssetsBegin;
    }

    public void setOtherLongTermAssetsBegin(String otherLongTermAssetsBegin) {
        this.otherLongTermAssetsBegin = otherLongTermAssetsBegin;
    }

    public String getOtherLongTermAssetsEnd() {
        return otherLongTermAssetsEnd;
    }

    public void setOtherLongTermAssetsEnd(String otherLongTermAssetsEnd) {
        this.otherLongTermAssetsEnd = otherLongTermAssetsEnd;
    }
    ...
    public String getTotalIntangibleAssetsAndOtherAssetsBegin() {
        return totalIntangibleAssetsAndOtherAssetsBegin;
    }

    public void setTotalIntangibleAssetsAndOtherAssetsBegin(String totalIntangibleAssetsAndOtherAssetsBegin) {
        this.totalIntangibleAssetsAndOtherAssetsBegin = totalIntangibleAssetsAndOtherAssetsBegin;
    }

    public String getTotalIntangibleAssetsAndOtherAssetsEnd() {
        return totalIntangibleAssetsAndOtherAssetsEnd;
    }

    public void setTotalIntangibleAssetsAndOtherAssetsEnd(String totalIntangibleAssetsAndOtherAssetsEnd) {
        this.totalIntangibleAssetsAndOtherAssetsEnd = totalIntangibleAssetsAndOtherAssetsEnd;
    }

    public String getStatutoryPublicWelfareFundBegin() {
        return statutoryPublicWelfareFundBegin;
    }

    public void setStatutoryPublicWelfareFundBegin(String statutoryPublicWelfareFundBegin) {
        this.statutoryPublicWelfareFundBegin = statutoryPublicWelfareFundBegin;
    }

    public String getStatutoryPublicWelfareFundEnd() {
        return statutoryPublicWelfareFundEnd;
    }

    public void setStatutoryPublicWelfareFundEnd(String statutoryPublicWelfareFundEnd) {
        this.statutoryPublicWelfareFundEnd = statutoryPublicWelfareFundEnd;
    }
