...
public class QxbCopyrightSqlProvider {

    public String insertSelective(QxbCopyright record) {
        BEGIN();
        INSERT_INTO("qxb_copyright");
    ...
    public String updateByPrimaryKeySelective(QxbCopyright record) {
        BEGIN();
